...
use Taller\Bundle\CursoBundle\Entity\Alumno;
use Taller\Bundle\CursoBundle\Form\AlumnoType;
...
class AlumnoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TallerCursoBundle:Alumno')->findAll();
     ...
     * @Method("POST")
     * @Template("TallerCursoBundle:Alumno:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TallerCursoBundle:Alumno')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TallerCursoBundle:Alumno:edit.html.twig")
     */
